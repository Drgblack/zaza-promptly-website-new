      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-800 mb-6">
            Why <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Zaza Promptly</span>?
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover why thousands of teachers choose our AI-powered solution for meaningful student feedback.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 mb-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We&apos;re working hard to bring you detailed information about why Zaza Promptly is the perfect choice for educators.
            </p>
            <Link 
              href="/"
